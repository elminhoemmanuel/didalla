    ...
    return (
        <div >
            <div className='w-3/4 md:w-1/2 lg:w-2/6 my-0 mx-auto text-center' >
                    ...
                    {
                        isloading ? <div className='text-center flex flex-row justify-center items-center'><img className="w-16 h-16" src="/images/loading.gif" alt="loading gif"/></div>: <div>
                            {responsegotten}
                        </div>
                    }

                    {responsegotten && <div>You can <Link href="/login"><a className='text-didalla'>login here</a></Link></div>}      
